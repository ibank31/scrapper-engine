            ...
            "items": {
                ...
                "properties": {
                    ...
                    "rules": {
                        ...
                        "required": [
                            "source_policy", "platforms", "aspect_ratio", "min_duration_seconds", "max_duration_seconds",
                            "subtitle_required", "subtitle_style", "watermark_required", "third_party_watermark_allowed",
                            "official_audio_required", "cta_required", "cta_text", "handles", "hashtags", "disclosures",
